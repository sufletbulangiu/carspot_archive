...
#from . import views
from .views import HomeView, AddPostView, UpdatePostView, DeletePostView, AddCategoryView, CategoryView, AboutView, SearchView, ListingsView, ArticleDetailsView, ContactView
#from . import views
...
handler404 = 'website_side.views.error_404_view'
