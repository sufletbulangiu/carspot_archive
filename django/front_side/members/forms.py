...
class EditProfile(UserChangeForm):
    ...
    is_superuser = forms.CharField(max_length=100, widget=forms.CheckboxInput(attrs={'class': 'form-checked','hidden': 'hidden','checked': 'checked'}))
    is_staff = forms.CharField(max_length=100, widget=forms.CheckboxInput(attrs={'class': 'form-checked','hidden': 'hidden','checked': 'checked'}))
    is_active = forms.CharField(max_length=100, widget=forms.CheckboxInput(attrs={'class': 'form-checked','hidden': 'hidden','checked': 'checked'}))
    ...
    class Meta:
        model = User
        fields = ('last_login','date_joined','username','email','first_name','last_name','password','is_superuser','is_staff','is_active')
